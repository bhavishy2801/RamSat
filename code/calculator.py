...
class RamseyGUI:
    ...
    def __init__(self, root):
        ...
        self.visualizer = AnimatedGraphVisualizer(None)
    ...
    def create_widgets(self):
        ...
        # Container for toggling between input and results
        ...
        # Result Display Area (Below Graph)
    ...
    def update_displays(self, k1, k2, result, stats, elapsed):
        ...
        # Update panel result label
        self.result_value_label_panel.config(
            text=f"R({k1}, {k2}) = {result}"
        )

        # Clear and populate statistics
